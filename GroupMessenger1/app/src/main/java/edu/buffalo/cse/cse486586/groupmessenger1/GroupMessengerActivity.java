...
public class GroupMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try{
                while(true) {
                    ...
                    if(receivedMsg != null){
                        publishProgress(receivedMsg,String.valueOf(GroupMessengerActivity.receivedCount));
                        GroupMessengerActivity.receivedCount++;
                    }
        ...
        protected void onProgressUpdate(String...strings) {
            ...
            keyValueToInsert.put(GroupMessengerActivity.KEY, strings[1]);
            keyValueToInsert.put(GroupMessengerActivity.VALUE, strReceived);
